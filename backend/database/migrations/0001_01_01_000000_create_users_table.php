...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('users', function (Blueprint $table) {
            ...
            $table->enum('goal', ['fat_loss', 'maintenance', 'muscle_gain'])->nullable();
            ...
            $table->unsignedSmallInteger('target_protein')->nullable();
            $table->unsignedSmallInteger('target_carbs')->nullable();
            $table->unsignedSmallInteger('target_fat')->nullable();
            $table->rememberToken();
            $table->timestamps();
        });
